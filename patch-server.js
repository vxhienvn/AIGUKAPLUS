...
if (!source.includes("installStableV7Dashboard(app)")) {
  ...
  if (!source.includes(routeAnchor)) {
    throw new Error("SERVER_ROUTE_ANCHOR_NOT_FOUND");
  }
...
for (const version of [
  "1.0.3-test-no-browser-key",
  "1.0.4-test-rpc-data",
  "1.0.5-learning-tags",
  "1.0.6-control-center-fix",
  "1.0.7-all-ui-green",
  "1.1.0-v7-dashboard-bridge",
  "1.1.1-v7-import-pending",
]) {
  source = source.replaceAll(version, "1.2.0-v7-stable-dashboard");
}

fs.writeFileSync(file, source);
console.log("[AIGUKA] Stable V7 dashboard installed; V8 core preserved on /v8-* routes");